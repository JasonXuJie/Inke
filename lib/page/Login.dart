          ...
          child: Column(
            children: <Widget>[
              ...
              Padding(
                ...
                child:Theme(data: ThemeData(primaryColor: Colors.black,hintColor: Colors.black),
                    child: TextField(
               ...
               Padding(
                  ...
                  child: RaisedButton(
                    ...
                    child: Container(
                        height: 50.0,
                        child: Center(
                          child: Text('登陆',style: TextStyle(color: Colors.white,fontSize: 18.0),),
                        )
                    ),
               ...
               Padding(
                 ...
                 child: OutlineButton(
                     ...
                     child: Container(
                       height: 50.0,
                       child: Center(
                         child: Text('注册',style: TextStyle(color: Colors.blue,fontSize: 18.0),),
                       ),
                     ),
                     onPressed: (){
