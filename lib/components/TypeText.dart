...
class TypeText extends StatefulWidget{
  ...
  @override
  State<StatefulWidget> createState() => _TypeTextState();

}


class _TypeTextState extends State<TypeText> with SingleTickerProviderStateMixin{
  ...
  void initState() {
    ...
    animation = IntTween(begin: 0,end: widget.text.length)
      ...
      return RichText(
        ...
        text: TextSpan(
          children: <TextSpan>[
            ...
            TextSpan(text: hideText,style: widget.style.copyWith(color: Colors.transparent))
          ]
        ),
      );
  }
