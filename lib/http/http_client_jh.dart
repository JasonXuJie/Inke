...
class HttpClientJh{
  ...
  static final HttpClientJh _instance = HttpClientJh._internal();

  factory HttpClientJh() => _instance;

  ///创建dio实例对象
  HttpClientJh._internal(){
    if(_client == null){
  ...
  void _request({
    ...
    try {
       ...
       if(response.data['reason'] == 'success' || response.data['reason'] == '成功的返回'){
         ///成功
