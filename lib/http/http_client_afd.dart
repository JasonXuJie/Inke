...
class HttpClientAfd{
  ...
  static final HttpClientAfd _instance = HttpClientAfd._internal();

  factory HttpClientAfd() => _instance;

  ///创建dio实例对象
  HttpClientAfd._internal(){
    if(_client == null){
  ...
  void _request({
    ...
    try {
       ...
       if(response.data['reason'] == 'Succes' || response.data['reason'] == '成功的返回'){
         ///成功
