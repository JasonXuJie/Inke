    ...
    return Column(
      children: <Widget>[
        ListTile(
          ...
          leading: Icon(Icons.history,size: 30.0,color: Colors.blue,),
          trailing: Icon(Icons.arrow_right),
          onTap: () {
            Navigator.of(context).push(MaterialPageRoute(builder: (context)=>HistoryDetailsPage(e_id: itemData.eId,title: itemData.title,)));
          },
        ),
        Divider(height: 1.0,)
      ],
